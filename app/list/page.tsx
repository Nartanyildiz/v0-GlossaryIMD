...
const dictionary = [
  ...
  },
  {
    ...
    definition: {
      ...
      IT: "Insieme delle spese associate a un progetto o una campagna di marketing, inclusi i costi correnti ed effettivi.",
  ...
  },
  {
    ...
    definition: {
      ...
      ALL: "Kohärente Sammlung von strukturellen Softwarekomponenten, die als Grundlage für die Erstellung von Software dienen.",
          ...
          {filteredWords.length > 0 ? (
            filteredWords.map((item, index) => (
              <div key={index} className="bg-[#1E2A3B] p-6 transition-all hover:bg-[#263447]">
                ...
                <p className="text-[#008170]/90">{item.definition[language]}</p>
              </div>
            ))
          ) : (
